...
class TestsDynamic:
    def test_cells_dynamic(self, toy_domain_64px_cells):
        ...
        test_existing_glacier_growth_within_band_replacing_all_open_ground()
        test_new_glacier_growth_into_band_and_replacing_all_open_ground()
        test_new_glacier_growth_into_new_higher_band()
