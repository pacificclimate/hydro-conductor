...
# These are set in the VIC header snow.h. Maybe they should be passed in via the state file?
...
# Areas where snow/ice coverage exceeds GLACIER_THICKNESS_THRESHOLD
