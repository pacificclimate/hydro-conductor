...
def read_gsa_headers(dem_file):
	...
	with open(dem_file, 'r') as f:
	    # First line
	  	...
	  	assert (abbreviation == 'DSAA'), 'read_gsa_headers({}): DSAA header on first line of DEM file was not found or is malformed.  DEM file does not conform to ASCII grid format.'.format(dem_file)
	  	# Second line
